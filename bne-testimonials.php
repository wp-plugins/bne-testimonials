...
define( 'BNE_TESTIMONIALS_VERSION', '1.6.2' );
 ...
 *	- Since we need to use get_the_content in our shortcode/widget output,
 *	- we want to keep the origional post formatting but strip out the stuff
 *	- we don't need, like share icons.
 *
 *	$options - Pulls in Array Options
 *	$allowed_tags - allowed tags on nl2br
 *	$get_content - our nl2br strip function on get_the_content
 *
 *	@since v1.1
 *	@updated Dec 27 2013
*/
function bne_testimonials_the_content( $options ) {
	$allowed_tags = '<b><strong><i><em><a><br><p><h1><h2><h3><h4><h5><h6><img>';
	$get_content = strip_tags( nl2br( get_the_content('') ), $allowed_tags );
